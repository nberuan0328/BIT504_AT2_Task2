...
public class GameMain extends JPanel implements MouseListener {
    ...
    public GameMain() {
        // Setup the MouseListener for this JPanel
     ...
     *  If none then GameState remains playing. If win or Draw then call is made to method that resets the game board.
    ...
    // Other mouse event methods are not used, so they remain as stubs
    @Override
